  ...
  changeActiveMenuItem() {
    ...
    if (activeItem) {
      if (activeItem.getAttribute(`data-href`) === `prizes`) {
        _prizes__WEBPACK_IMPORTED_MODULE_2__["default"].startAnimation();
      } else if (activeItem.getAttribute(`data-href`) === `game`) {
        _game_timer__WEBPACK_IMPORTED_MODULE_1__["default"].start();
      }
...
/* harmony default export */ __webpack_exports__["default"] = (new GameTimer());
...
const drawPrizesCount = ({element, start, end, step}) => {
  let count = start;
  Object(_utils__WEBPACK_IMPORTED_MODULE_0__["startDrawingByFps"])(() => {
    count += step;
...
/* harmony default export */ __webpack_exports__["default"] = (new Prizes());
  ...
  if (results.length) {
    for (let i = 0; i < showResultEls.length; i++) {
      showResultEls[i].addEventListener(`click`, function () {
        ...
        _game_timer__WEBPACK_IMPORTED_MODULE_0__["default"].stop();
      });
    }
    ...
    if (playBtn) {
      playBtn.addEventListener(`click`, function () {
        ...
        _game_timer__WEBPACK_IMPORTED_MODULE_0__["default"].start();
      });
    }
  }
});
...
/*!************************************!*\
  !*** ./source/js/modules/utils.js ***!
  \************************************/
/*! exports provided: startDrawingByFps */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "startDrawingByFps", function() { return startDrawingByFps; });
const startDrawingByFps = (callback, fps) => {
